...
public class BatteryInventoryCanvasUIBackroomsMinimalFixed : MonoBehaviour
{
    [Header("References")]
    ...
    {
        root = new GameObject("BackroomsBatteryInventoryMinimalFixed");
        ...
        CreateLabelPlate(leftColumn.transform, "HOTBAR", new Vector2(0.5f, 1f), new Vector2(0f, -26f), new Vector2(148f, 30f));
        CreateLabelPlate(leftColumn.transform, "MAIN HAND", new Vector2(0.5f, 1f), new Vector2(0f, -114f), new Vector2(148f, 30f));
        CreateRectImage("MainHandSlot", leftColumn.transform, new Vector2(0.5f, 1f), new Vector2(108f, 108f), new Vector2(0f, -198f), slotColor);
        CreateLabelPlate(leftColumn.transform, "POCKETS", new Vector2(0.5f, 0f), new Vector2(0f, 138f), new Vector2(148f, 30f));
        CreateRectImage("PocketA", leftColumn.transform, new Vector2(0.5f, 0f), new Vector2(108f, 108f), new Vector2(0f, 96f), slotColor);
        CreateRectImage("PocketB", leftColumn.transform, new Vector2(0.5f, 0f), new Vector2(108f, 108f), new Vector2(0f, 210f), slotColor);
