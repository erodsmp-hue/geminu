...
public class BatteryInventoryCanvasUIStylizedV3 : MonoBehaviour
{
    ...
    private Text helpLeft;
    private Text helpCenter;
    private Text helpRight;
    ...
    {
        Transform existing = transform.Find("StylizedBatteryInventoryCanvasV3");
        if (existing != null)
        {
        ...
        root = new GameObject("StylizedBatteryInventoryCanvasV3");
        ...
        dimImage = dim.AddComponent<Image>();
        dimImage.color = new Color(0f, 0f, 0f, 0.48f);
        ...
        titleText = CreateText("Title", panel.transform, "Inventory", new Vector2(0f, 1f), new Vector2(56f, -52f), 42, TextAnchor.MiddleLeft, FontStyle.Bold);
        subtitleText = CreateText("Subtitle", panel.transform, "Emergency Supplies", new Vector2(0f, 1f), new Vector2(56f, -92f), 18, TextAnchor.MiddleLeft, FontStyle.Italic);
        subtitleText.color = new Color(1f, 1f, 1f, 0.54f);
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            AddEvent(trigger, EventTriggerType.PointerEnter, () => { selectedIndex = index; Refresh(); });
        ...
        GameObject sideInfo = CreateUIObject("SideInfo", panel.transform, new Vector2(1f, 1f), new Vector2(170f, 160f));
        sideInfo.GetComponent<RectTransform>().pivot = new Vector2(1f, 1f);
        sideInfo.GetComponent<RectTransform>().anchoredPosition = new Vector2(-60f, -164f);
        Text sideTitle = CreateText("SideTitle", sideInfo.transform, "Status", new Vector2(0f, 1f), new Vector2(0f, 0f), 22, TextAnchor.UpperLeft, FontStyle.Bold);
        Text sideLine1 = CreateText("SideLine1", sideInfo.transform, "Paused", new Vector2(0f, 1f), new Vector2(0f, -36f), 18, TextAnchor.UpperLeft, FontStyle.Normal);
        Text sideLine2 = CreateText("SideLine2", sideInfo.transform, "Mouse select", new Vector2(0f, 1f), new Vector2(0f, -68f), 18, TextAnchor.UpperLeft, FontStyle.Normal);
        Text sideLine3 = CreateText("SideLine3", sideInfo.transform, "Arrow key select", new Vector2(0f, 1f), new Vector2(0f, -100f), 18, TextAnchor.UpperLeft, FontStyle.Normal);
        sideTitle.color = new Color(1f, 1f, 1f, 0.90f);
        sideLine1.color = sideLine2.color = sideLine3.color = new Color(1f, 1f, 1f, 0.68f);
        ...
        helpLeft = CreateText("HelpLeft", helpRow.transform, "TAB  Close", new Vector2(0f, 0.5f), new Vector2(0f, 0f), 18, TextAnchor.MiddleLeft, FontStyle.Normal);
        helpCenter = CreateText("HelpCenter", helpRow.transform, "ARROWS / MOUSE  Select", new Vector2(0.5f, 0.5f), new Vector2(0f, 0f), 18, TextAnchor.MiddleCenter, FontStyle.Normal);
        helpRight = CreateText("HelpRight", helpRow.transform, "ENTER / R  Use", new Vector2(1f, 0.5f), new Vector2(0f, 0f), 18, TextAnchor.MiddleRight, FontStyle.Normal);
    ...
    private void Refresh()
    {
        ...
        descBody.text = hasItem
            ? "Spare flashlight battery. Use it to restore full torch power before the hallway goes dark again."
            : "No item stored in this slot.";
