...
public class BatteryInventoryCanvasUIBackroomsMinimalFixedV2 : MonoBehaviour
{
    [Header("References")]
    ...
    {
        root = new GameObject("BackroomsBatteryInventoryMinimalFixedV2");
        ...
        CreateText("Header", root.transform, "Inventory", 34, FontStyle.Bold, titleColor, TextAnchor.MiddleRight, new Vector2(1f, 1f), new Vector2(-42f, -34f), new Vector2(320f, 38f));
        CreateText("Helper", root.transform, "TAB close   ARROWS move   ENTER / R equip", 14, FontStyle.Normal, dimColor, TextAnchor.MiddleRight, new Vector2(1f, 0f), new Vector2(-42f, 28f), new Vector2(420f, 20f));

        GameObject leftColumn = CreateRect("LeftColumn", root.transform, new Vector2(0f, 0.5f), new Vector2(240f, 470f), new Vector2(180f, 0f));
        leftColumn.AddComponent<Image>().color = frameColor;
        CreateRectImage("LeftInner", leftColumn.transform, new Vector2(0.5f, 0.5f), new Vector2(224f, 454f), Vector2.zero, panelColor);

        CreateLabelPlate(leftColumn.transform, "HOTBAR", new Vector2(0.5f, 1f), new Vector2(0f, -26f), new Vector2(150f, 28f));
        CreateRectImage("HotbarSlot", leftColumn.transform, new Vector2(0.5f, 1f), new Vector2(108f, 48f), new Vector2(0f, -76f), slotColor);

        CreateLabelPlate(leftColumn.transform, "MAIN HAND", new Vector2(0.5f, 1f), new Vector2(0f, -150f), new Vector2(150f, 28f));
        CreateRectImage("MainHandSlot", leftColumn.transform, new Vector2(0.5f, 1f), new Vector2(108f, 108f), new Vector2(0f, -238f), slotColor);

        CreateLabelPlate(leftColumn.transform, "POCKETS", new Vector2(0.5f, 0f), new Vector2(0f, 142f), new Vector2(150f, 28f));
        CreateRectImage("PocketA", leftColumn.transform, new Vector2(0.5f, 0f), new Vector2(108f, 64f), new Vector2(0f, 88f), slotColor);
        CreateRectImage("PocketB", leftColumn.transform, new Vector2(0.5f, 0f), new Vector2(108f, 64f), new Vector2(0f, 20f), slotColor);

        GameObject centerPanel = CreateRect("CenterPanel", root.transform, new Vector2(0.5f, 0.5f), new Vector2(426f, 392f), new Vector2(4f, 4f));
        centerPanel.AddComponent<Image>().color = new Color(frameColor.r, frameColor.g, frameColor.b, 0.08f);
        CreateRectImage("CenterInner", centerPanel.transform, new Vector2(0.5f, 0.5f), new Vector2(408f, 374f), Vector2.zero, panelColor);
        CreateLabelPlate(centerPanel.transform, "BACKPACK", new Vector2(0.5f, 1f), new Vector2(0f, -20f), new Vector2(150f, 30f));

        GameObject grid = CreateRect("Grid", centerPanel.transform, new Vector2(0.5f, 0.5f), new Vector2(360f, 246f), new Vector2(0f, -8f));
        ...
        {
            GameObject slot = CreateRect("Slot_" + i, grid.transform, new Vector2(0.5f, 0.5f), new Vector2(112f, 112f), Vector2.zero);
            ...
            GameObject inner = CreateRect("Inner", slot.transform, new Vector2(0.5f, 0.5f), new Vector2(104f, 104f), Vector2.zero);
            Image panel = inner.AddComponent<Image>();
            panel.color = slotColor;
            slotPanels.Add(panel);

            Text num = CreateText("Number", inner.transform, (i + 1).ToString("00"), 12, FontStyle.Bold, dimColor, TextAnchor.MiddleLeft, new Vector2(0f, 1f), new Vector2(7f, -9f), new Vector2(28f, 14f));
            slotNumbers.Add(num);

            Image icon = CreateRectImage("Icon", inner.transform, new Vector2(0.5f, 0.5f), new Vector2(36f, 66f), new Vector2(0f, 2f), batteryOffColor);
            if (batteryIcon != null)
            {
        ...
        GameObject detailPanel = CreateRect("DetailPanel", root.transform, new Vector2(1f, 0.5f), new Vector2(230f, 392f), new Vector2(-176f, 4f));
        detailPanel.AddComponent<Image>().color = frameColor;
        CreateRectImage("DetailInner", detailPanel.transform, new Vector2(0.5f, 0.5f), new Vector2(214f, 376f), Vector2.zero, panelColor);
        detailTitleText = CreateText("DetailTitle", detailPanel.transform, "EMPTY SLOT", 22, FontStyle.Bold, titleColor, TextAnchor.MiddleCenter, new Vector2(0.5f, 1f), new Vector2(0f, -28f), new Vector2(190f, 26f));
        CreateRectImage("Preview", detailPanel.transform, new Vector2(0.5f, 0.5f), new Vector2(158f, 220f), new Vector2(0f, -2f), new Color(0.07f, 0.10f, 0.11f, 0.55f));
        detailBodyText = CreateText("DetailBody", detailPanel.transform, "No cell stored.", 14, FontStyle.Normal, textColor, TextAnchor.MiddleCenter, new Vector2(0.5f, 0f), new Vector2(0f, 18f), new Vector2(180f, 40f));

        footerText = CreateText("Footer", root.transform, "No spare cells", 15, FontStyle.Normal, textColor, TextAnchor.MiddleRight, new Vector2(1f, 0f), new Vector2(-42f, 88f), new Vector2(220f, 20f));
    }
    ...
    private void CreateLabelPlate(Transform parent, string text, Vector2 anchor, Vector2 pos, Vector2 size)
    {
        ...
        CreateText("Text", plate.transform, text, 13, FontStyle.Bold, titleColor, TextAnchor.MiddleCenter, new Vector2(0.5f, 0.5f), Vector2.zero, new Vector2(size.x - 10f, size.y - 8f));
    }
